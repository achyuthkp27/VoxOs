...
actor WhisperContext {
    ...
    private let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "WhisperContext")
    ...
    func fullTranscribe(samples: [Float]) -> Bool {
        ...
        let isVADEnabled = UserDefaults.standard.bool(forKey: DefaultsKeys.isVADEnabled)
