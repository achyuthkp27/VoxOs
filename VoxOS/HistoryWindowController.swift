...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    private let windowIdentifier = NSUserInterfaceItemIdentifier("com.achyuthkp.voxos.historyWindow")
    private let windowAutosaveName = NSWindow.FrameAutosaveName("VoxOSHistoryWindowFrame")

    private override init() {
        super.init()
    }

    func showHistoryWindow(modelContainer: ModelContainer, engine: VoxOSEngine) {
    ...
    private func createHistoryWindow(modelContainer: ModelContainer, engine: VoxOSEngine) -> NSWindow {
