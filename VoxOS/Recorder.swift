...
class Recorder: NSObject, ObservableObject {
    ...
    let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "Recorder")
    ...
    let audioSetupQueue = DispatchQueue(label: "com.achyuthkp.voxos.audioSetup", qos: .userInitiated)
