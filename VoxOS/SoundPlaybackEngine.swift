...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.achyuthkp.voxos.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "SoundPlaybackEngine")
