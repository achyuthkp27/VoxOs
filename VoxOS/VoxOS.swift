...
struct VoxOSApp: App {
    ...
    @StateObject private var engine: VoxOSEngine
    ...
    init() {
        ...
        let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "Initialization")
            ...
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    alert.informativeText = String(
                        localized:
                            "VoxOS couldn't access its storage location. Your transcriptions will not be saved between sessions."
                    )
                ...
                fatalError(
                    "VoxOS failed to initialize storage.\nPersistent:\n\(persistentDetail)\nIn-memory:\n\(memoryDetail)"
                )
            }
        }
    ...
    var body: some Scene {
        Window("VoxOS", id: AppWindowID.main) {
            Group {
