...
enum DashboardInsightPeriod: String, CaseIterable, Identifiable, Sendable {
    ...
    var timeSavedContext: LocalizedStringKey {
        switch self {
        case .today: return "with VoxOS today"
        case .lastSevenDays: return "with VoxOS this week"
        case .lastThirtyDays: return "with VoxOS over the last 30 days"
        case .thisYear: return "with VoxOS this year"
        case .allTime: return "with VoxOS"
        }
    }
