...
struct OnboardingContextAwarenessScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            title: "VoxOS is Context-Aware",
            subtitle: "VoxOS automatically understands what you are working with and selects your preferred setup.",
...
private struct ContextAwarenessCenterSlot: View {
    var body: some View {
        ContextAwarenessModeVisual()
            ...
            .accessibilityLabel(
                "VoxOS modes include Dictation, Enhance, Email, Assistant, Rewrite, Ask, Summarize, and Translate.")
    }
}
