...
final class LicenseViewModel: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "LicenseViewModel")
    ...
    private let pendingRemovalKey = "VoxOSLicenseRemovalPending"
    ...
    var usageRestrictionMessage: String? {
        ...
        case .unlicensed, .trialExpired:
            return String(
                format: String(localized: "Your trial has ended. Upgrade to VoxOS Pro at %@"),
                "tryvoiceink.com/buy"
            )
        case .trial, .licensed:
            return nil
    ...
    func validateLicense(_ submittedKey: String) async {
        ...
        do {
            ...
            setStorageError(String(localized: "VoxOS couldn't save the license. Please try again."))
    ...
    func deactivateLicense() async {
        ...
        do {
            ...
            setStorageError(String(localized: "VoxOS couldn't remove the saved license. Please try again."))
        } catch {
    ...
    private var keychainUnavailableMessage: String {
        let recoveryMessage = String(
            localized:
                "VoxOS couldn't access the macOS Keychain. Quit and reopen VoxOS. If the problem continues, restart your Mac."
        )
