...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "LogExporter")
    private let subsystem = "com.achyuthkp.voxos"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== VoxOS Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "VoxOS_Logs_\(timestamp).log"
