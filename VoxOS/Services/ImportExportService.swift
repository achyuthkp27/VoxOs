...
class ImportExportService {
    ...
    func exportSettings(
        ...
        do {
            ...
            savePanel.nameFieldStringValue = "VoxOS_Settings_Backup.json"
            savePanel.title = String(localized: "Export VoxOS Settings")
    ...
    func importSettings(
        ...
        openPanel.title = String(localized: "Import VoxOS Settings")
    ...
    private func showImportSuccessAlert(message: String, needsAPIKeyReminder: Bool) {
        DispatchQueue.main.async {
            ...
            informativeText +=
                "\n\n" + String(localized: "It is recommended to restart VoxOS for all changes to take full effect.")
