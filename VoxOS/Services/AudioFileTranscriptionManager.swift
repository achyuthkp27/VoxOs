...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: VoxOSEngine, mode: ModeConfig) {
    ...
    private func processItem(
        _ item: AudioFileQueueItem, modelContext: ModelContext, engine: VoxOSEngine, mode: ModeConfig
    ) async {
