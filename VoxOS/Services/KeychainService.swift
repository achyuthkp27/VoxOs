...
final class KeychainService {
    ...
    private let logger = Logger(subsystem: "com.achyuthkp.voxos", category: "KeychainService")
    #if LOCAL_BUILD
        private let service = "com.achyuthkp.VoxOS.Local"
        private let defaults = UserDefaults.standard
        private let legacyLocalPrefix = "LocalKeychain_"
    #else
        private let service = "com.achyuthkp.VoxOS"
    #endif
